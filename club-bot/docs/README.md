...
| **[権限レベル別 取扱説明書（PDF）](role_manual.pdf)** | Discord をはじめて使う人向けの冊子。コマンドの打ち方から、L1一般メンバー／L2班長／L3幹部／L4Bot管理者 の権限ごとにできること、Web ダッシュボードの使い方までを図で説明（[HTML 版](role_manual.html)） |
