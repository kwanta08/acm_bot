...
| ドキュメント | 内容 |
|---|---|
| **[紹介リーフレット（PDF）](leaflet.pdf)** | 他のサークルへ Bot を紹介するための A4 両面1枚。何ができるか・導入の3ステップ・Web ダッシュボードを図でまとめています。印刷用の PDF のほか、SNS やチャットへ貼れるページごとの画像（[表面](leaflet-1.png) / [裏面](leaflet-2.png)）と [HTML 版](leaflet.html)。新歓や他大学との交流での配布向け |
