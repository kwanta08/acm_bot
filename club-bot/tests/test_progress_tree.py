...
def _node(node_id: str, parent_id: str | None = None, *,
          progress: float | None = None, order: float = 0.0,
          weight: float = 1.0) -> ProgressNode:
    return ProgressNode(node_id=node_id, parent_id=parent_id, name=node_id,
                        manual_progress=progress, order=order, weight=weight)
