...
class TaskRepository(BaseRepository):
    ...
    async def set_todoist_id(self, guild_id: int, local_task_id: int, todoist_task_id: str) -> None:
    ...
    async def set_assignee(
        self, guild_id: int, local_task_id: int, assignee_id: str | None
    ) -> None:
        await self.db.execute(
    ...
    async def list_due_within(
        self, guild_id: int, today_iso_date: str, until_iso_date: str
    ) -> list[dict[str, Any]]:
