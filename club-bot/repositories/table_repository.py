...
TABLES: dict[str, TableSpec] = {
    "tasks": TableSpec(
        ...
        searchable=("title", "team_key", "status", "due_date"),
        columns=(
    ...
    "members": TableSpec(
        ...
        searchable=("display_name", "primary_team", "skills", "notes"),
        columns=(
    ...
    "incidents": TableSpec(
        ...
        searchable=("place", "description", "injury", "prevention", "reporter_name"),
